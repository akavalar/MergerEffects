                         ...
                         retries)
{
  if (diagnostics==0) {
    # slope parameters
    slopeAndR <- MergerEffects::slopeLinLog(q0=q0,
                                               p0=p0,
                                               c0=c0,
                                               PoD=PoD,
                                               conPre=conPre,
    ...
    # intercept
    intercept <- MergerEffects::interceptLinLog(slope=slope,
                                                   p0=p0,
                                                   q0=q0,
                                                   R=R,
                                                   PoD=PoD,
    ...
    # simulate new prices
    p1 <- MergerEffects::simulateLinLog(slope=slope,
                                           p0=p0,
                                           c1=c1,
                                           intercept=intercept,
                                           conPost=conPost,
    ...
    q1 <- MergerEffects::demandLinLog(intercept=intercept,
                                         price=p1,
                                         slope=slope,
                                         n=n)
    ...
    # intercept
    interceptList <- MergerEffects::interceptLinLog(slope=slope,
                                                       p0=p0,
                                                       q0=q0,
                                                       R=R,
                                                       PoD=PoD,
    ...
    # simulate new prices
    p1List <- MergerEffects::simulateLinLog(slope=slope,
                                               p0=p0,
                                               c1=c1,
                                               intercept=intercept,
                                               conPost=conPost,
